component extends="testbox.system.BaseSpec" {
    ...
    function run() {
        describe( "Derby unsupported DML row-selection regression", function() {
    ...
    private any function configuredBuilder( required string selection ) {
        var builder = new qb.models.Query.QueryBuilder( grammar = new qb.models.Grammars.DerbyGrammar() ).from( "jobs" );
