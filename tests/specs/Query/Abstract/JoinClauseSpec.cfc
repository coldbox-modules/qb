            ...
            describe( "adding join conditions", function() {
                ...
                describe( "on()", function() {
                    it( "can add a single join condition", function() {
                        ...
                        expect( clause.first.toString().toString() ).toBe(
                            "first.id",
                            "First column should be [first.id]"
                        );
                        expect( clause.operator ).toBe( "=", "Operator should be [=]" );
                        expect( clause.second.toString().toString() ).toBe(
                            "second.first_id",
                    ...
                    it( "defaults to ""and"" for the combinator and ""false"" for the where flag", function() {
                        ...
                        expect( clause.operator ).toBe( "=", "Operator should be [=]" );
                        expect( clause.second.toString() ).toBe(
                            "second.first_id",
                            "First column should be [second.first_id]"
                        );
                        expect( clause.combinator ).toBe( "and" );
                    ...
                    it( "can add multiple join clauses", function() {
                        ...
                        expect( clauseTwo.first.toString() ).toBe(
                            "first.locale",
                            "First column should be [first.locale]"
                        );
                        expect( clauseTwo.operator ).toBe( "=", "Operator should be [=]" );
                        expect( clauseTwo.second.toString() ).toBe(
                            "second.locale",
                ...
                describe( "orOn()", function() {
                    it( "can add a single join condition", function() {
                        ...
                        var clause = clauses[ 1 ];
                        expect( clause.first.toString() ).toBe(
                            "first.another_value",
                ...
                describe( "where()", function() {
                    it( "adds a where statement to a join clause", function() {
                        ...
                        var clause = clauses[ 1 ];
                        expect( clause.column.toString() ).toBe(
                            "second.locale",
                            "First column should be [second.locale]"
                        );
                        expect( clause.operator ).toBe( "=", "Operator should be [>=]" );
